                    ...
                    <div class="relative">
                        <div class="flex items-center gap-4">
                            ...
                            <?php if ( $_SESSION['user'] ?? false ) :  ?> 
                                ...
                                <a href="/logout" class="<?= urlIs('/logout') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' ?> rounded-md px-3 py-2 text-sm font-medium">Log out</a>
